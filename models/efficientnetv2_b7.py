...
def build_efficientnetv2_b7(input_shape=None, num_classes=None, freeze_base=True, learning_rate=1e-4):
    input_shape = input_shape or Config.IMAGE_SHAPE
    num_classes = num_classes or Config.NUM_CLASSES

    base_model = EfficientNetV2B7(include_top=False, weights="imagenet", input_shape=input_shape)
