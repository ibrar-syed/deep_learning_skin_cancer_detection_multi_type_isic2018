...
def build_nasnetmobile(input_shape=None, num_classes=None, freeze_base=True, learning_rate=1e-4):
    """
    Builds a NASNetMobile model with custom classification head.
